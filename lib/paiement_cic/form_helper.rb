...
module PaiementCic::FormHelper
  def paiement_cic_hidden_fields(price, order_reference, options = {})
    ...
    html = '
        ...
        <input type="hidden" name="url_retour"        id="url_retour"     value="' + options[:return_url] + '" />
        <input type="hidden" name="url_retour_ok"     id="url_retour_ok"  value="' + options[:return_url_ok] + '" />
        <input type="hidden" name="url_retour_err"    id="url_retour_err" value="' + options[:return_url_err] + '" />
